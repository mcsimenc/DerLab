...
When developing a script it can really help slim down the time you spend typing in the same thing over and over and over and over again, which gets to be frustratingly boring! Well, without these shortcuts, that is. Using shortcuts with aliases and environment variables can make you feel like a computer whiz, so give it a try.

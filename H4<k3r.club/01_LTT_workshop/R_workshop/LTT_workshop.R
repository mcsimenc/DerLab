...
# 4.
# Leave R and go to the Finder. Go back to the Terminal window for the session
...
# to make an LTT plot. Then go back to R.

# 6.
# Back in R, from the list.files() output, copy the name of the file ending in
